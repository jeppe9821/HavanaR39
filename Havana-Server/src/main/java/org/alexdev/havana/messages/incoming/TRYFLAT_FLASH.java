...
package org.alexdev.havana.messages.incoming;
...
import org.alexdev.havana.messages.incoming.rooms.TRYFLAT;
...
public class TRYFLAT_FLASH extends TRYFLAT  {
    @Override
