...
{% if hasCollectable %}
		<div id="collectibles-current-img" style="background-image: url(http://localhost:8081/habbo-imaging/furni?sprite={{ collectableSprite }}&direction=2&canvas=transparent)"></div>
...
{% for entry in collectablesShowroom %}
	...
	<div class="collectibles-prodimg" style="background-image: url(http://localhost:8081/habbo-imaging/furni?sprite={{ entry.getSprite() }}&direction=2&icon=1&canvas=transparent);"></div>
	<h4>{{ entry.getName() }}</h4>
