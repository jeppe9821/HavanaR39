...
<ul class="roomselection-welcome clearfix">
	<li class="odd">
	<a class="roomselection-select new-button" href="flash_client?createRoom=0" target="flash_client" onclick="return RoomSelectionHabblet.create(this, 0);"><b>Select</b><i></i></a>
	</li>
	<li class="even">
	<a class="roomselection-select new-button" href="flash_client?createRoom=1" target="flash_client" onclick="return RoomSelectionHabblet.create(this, 1);"><b>Select</b><i></i></a>
	</li>
	<li class="odd">
	<a class="roomselection-select new-button" href="flash_client?createRoom=2" target="flash_client" onclick="return RoomSelectionHabblet.create(this, 2);"><b>Select</b><i></i></a>
	</li>
	<li class="even">
	<a class="roomselection-select new-button" href="flash_client?createRoom=3" target="flash_client" onclick="return RoomSelectionHabblet.create(this, 3);"><b>Select</b><i></i></a>
	</li>
	<li class="odd">
	<a class="roomselection-select new-button" href="flash_client?createRoom=4" target="flash_client" onclick="return RoomSelectionHabblet.create(this, 4);"><b>Select</b><i></i></a>
	</li>
	<li class="even">
	<a class="roomselection-select new-button" href="flash_client?createRoom=5" target="flash_client" onclick="return RoomSelectionHabblet.create(this, 5);"><b>Select</b><i></i></a>
	</li>
</ul>
