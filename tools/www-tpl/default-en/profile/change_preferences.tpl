...
<label><input type="radio" name="clientpreference" value="SHOCKWAVE" {{ playerDetails.clientPreference == "SHOCKWAVE" ? "checked" : "" }} />Shockwave</label>

<label><input type="radio" name="clientpreference" value="FLASH" {{ playerDetails.clientPreference == "FLASH" ? "checked" : "" }} />Flash</label>
</p>
...
<h3>Hotel view</h3>
<p>
The hotel view used on the Home page and in the Shockwave client<br />
</p>
<select id="hotel-view-select" name="hotelView">
	<option value="br" {{ playerDetails.hotelView == "br" ? "selected" : "" }}>Brazil</option>
	<option value="ca" {{ playerDetails.hotelView == "ca" ? "selected" : "" }}>Canada</option>
	<option value="dk" {{ playerDetails.hotelView == "dk" ? "selected" : "" }}>Denmark</option>
	<option value="fi" {{ playerDetails.hotelView == "fi" ? "selected" : "" }}>Finland</option>
	<option value="fr" {{ playerDetails.hotelView == "fr" ? "selected" : "" }}>France</option>
	<option value="de" {{ playerDetails.hotelView == "de" ? "selected" : "" }}>Germany</option>
	<option value="it" {{ playerDetails.hotelView == "it" ? "selected" : "" }}>Italy</option>
	<option value="jp" {{ playerDetails.hotelView == "jp" ? "selected" : "" }}>Japan</option>
	<option value="nl" {{ playerDetails.hotelView == "nl" ? "selected" : "" }}>Netherlands</option>
	<option value="no" {{ playerDetails.hotelView == "no" ? "selected" : "" }}>Norway</option>
	<!-- missing hotelview for me page <option value="ru" {{ playerDetails.hotelView == "ru" ? "selected" : "" }}>Russia</option>-->
	<option value="es" {{ playerDetails.hotelView == "es" ? "selected" : "" }}>Spain</option>	
	<option value="sg" {{ playerDetails.hotelView == "sg" ? "selected" : "" }}>Singapore</option>
	<option value="se" {{ playerDetails.hotelView == "se" ? "selected" : "" }}>Sweden</option>
	<option value="ch" {{ playerDetails.hotelView == "ch" ? "selected" : "" }}>Switzerland</option>
	<option value="uk" {{ playerDetails.hotelView == "uk" ? "selected" : "" }}>United Kingdom</option>
	<option value="us" {{ playerDetails.hotelView == "us" ? "selected" : "" }}>United States</option>
</select>
