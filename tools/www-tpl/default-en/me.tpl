      ...
      <body id="home" class=" ">
         ...
         <div id="navi2-container" class="pngbg">
            <div id="navi2" class="pngbg clearfix">
               <ul>
                  ...
                  <li class="">
                     <a href="{{ site.sitePath }}/home/{{ playerDetails.getName() }}">My Page</a>
                  </li>
                  <li class="">
                     <a href="{{ site.sitePath }}/profile">Account Settings</a>
                  </li>
                  <li class="">
         ...
         <div id="container">
            <div id="content">
               ...
               {% if alert.hasAlert %}
                <div style="margin-left: -2px; width: calc(100% - 2px); margin-bottom: 7px">
                <div class="rounded rounded-red">{{ alert.message }}<br />	</div>
                </div>
                {% endif %}
                {% if settingsSavedAlert %}
                <div style="margin-left: -2px; width: calc(100% - 2px); margin-bottom: 7px">
                <div class="rounded rounded-green">Successfully linked your account with Discord<br />	</div>
                </div>
                {% endif %}
                  ...
                  <div class="habblet-container ">
                     <div id="new-personal-info" style="background-image:url({{ site.staticContentPath }}/web-gallery/v2/images/personal_info/hotel_views/htlview_{{ playerDetails.hotelView }}.png)" />
                        {% if site.serverOnline %}
                        <div class="enter-hotel-btn">
                           <div class="open enter-btn">
                              <a href="{{ site.sitePath }}/client" target="client" onclick="openOrFocusHabbo(this); return false;">Shockwave<i></i></a>
                              <b></b>
                           </div>
                        </div>
                        <div class="enter-beta-btn">
                           <div class="open enter-btn">
                              <a href="{{ site.sitePath }}/flash_client" target="_self" onclick="window.location.href = this.href; return false;">Enter Flash<i></i></a>
                              <b></b>
                           </div>
                        </div>
                        {% else %}
                        ...
                        <ul id="link-bar" class="clearfix">
                           ...
                           <li class="credits">
                              <a href="{{ site.sitePath }}/credits">{{ playerDetails.credits }}</a> Credits
                           </li>
                           <li class="club">
                              {% if playerDetails.hasClubSubscription() %}
                              <a href="{{ site.sitePath }}/club">{{ hcDays }} </a>HC days
                           </li>
                           {% else %}
                           <a href="{{ site.sitePath }}/club">Join {{ site.siteName }} club &raquo;</a>		</li>
                           {% endif %}
                           <li class="activitypoints">
                              <a href="{{ site.sitePath }}/credits/pixels">{{ playerDetails.pixels }}</a> Pixels
                           </li>
                        </ul>
                        <div id="habbo-feed">
                           <ul id="feed-items">
                  ...
                  <div class="habblet-container" id="roomselection">
                     <div class="cbb clearfix rooms">
                        ...
                        <ul id="roomselection-plp" class="clearfix">
                           <li class="top">
                              <a class="roomselection-select new-button green-button" href="flash_client?createRoom=0" target="flash_client" onclick="return RoomSelectionHabblet.create(this, 0);"><b>Select</b><i></i></a>
                           </li>
                           <li class="top">
                              <a class="roomselection-select new-button green-button" href="flash_client?createRoom=1" target="flash_client" onclick="return RoomSelectionHabblet.create(this, 1);"><b>Select</b><i></i></a>
                           </li>
                           <li class="top">
                              <a class="roomselection-select new-button green-button" href="flash_client?createRoom=2" target="flash_client" onclick="return RoomSelectionHabblet.create(this, 2);"><b>Select</b><i></i></a>
                           </li>
                           <li class="bottom">
                              <a class="roomselection-select new-button green-button" href="flash_client?createRoom=3" target="flash_client" onclick="return RoomSelectionHabblet.create(this, 3);"><b>Select</b><i></i></a>
                           </li>
                           <li class="bottom">
                              <a class="roomselection-select new-button green-button" href="flash_client?createRoom=4" target="flash_client" onclick="return RoomSelectionHabblet.create(this, 4);"><b>Select</b><i></i></a>
                           </li>
                           <li class="bottom">
                              <a class="roomselection-select new-button green-button" href="flash_client?createRoom=5" target="flash_client" onclick="return RoomSelectionHabblet.create(this, 5);"><b>Select</b><i></i></a>
                           </li>
                        </ul>
                        <script type="text/javascript">
                     ...
                     <div class="cbb clearfix green ">
                        ...
                        <div id="tab-1-5-2-content" >
                           <div id="my-tag-info" class="habblet-content-info">
                              {% if tags|length < 1 %}
                              You have no tags.
                              {% endif %} Answer the question below or just add a tag of your choice.
                           </div>
