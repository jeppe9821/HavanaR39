...
import org.alexdev.http.controllers.habblet.*;
...
import org.alexdev.http.controllers.homes.widgets.*;
import org.alexdev.http.controllers.housekeeping.*;
import org.alexdev.http.controllers.site.*;
...
public class Routes {
    ...
    public static void register() {
        ...
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/room_badges", HousekeepingRoomBadgesController::roomBadges);
